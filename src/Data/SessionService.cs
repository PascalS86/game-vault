...
namespace Csandra.game_vault.wasm.App.Data{
    public class SessionService{
        ...
        private readonly GameVaultDataService _gameDataService;
        ...
        public SessionService(IJSRuntime jsRuntime, GameVaultDataService gameService)
        {
            _jsRuntime = jsRuntime;
            _gameDataService = gameService;
        }
            ...
            try{
                if(string.IsNullOrWhiteSpace(client))
                 ...
                 using(var httpClient = new HttpClient()){
                    ...
                    var response = await httpClient.PostAsync($"{_gameDataService.GetAPI()}/access", content);
